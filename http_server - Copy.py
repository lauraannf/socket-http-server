...
def response_path(path):
    ...
    # under webroot.
    home_directory = 'C:/Users/Laura.Fiorentino/Documents/MyPython/Python230/Lesson03/socket-http-server/webroot'
    if not os.path.exists(os.path.join(home_directory, path)):
        raise NameError
    if os.path.isdir(os.path.join(home_directory, path)):
